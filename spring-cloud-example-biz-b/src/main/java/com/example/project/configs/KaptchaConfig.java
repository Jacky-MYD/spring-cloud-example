...
import com.example.project.constants.SecurityConstants;
...
public class KaptchaConfig {
    ...
    private static final Object KAPTCHA_IMAGE_FONT_WATER = "kaptcha.obscurificator.impl";
    ...
    public DefaultKaptcha producer() {
        ...
        properties.put(KAPTCHA_IMAGE_FONT_WATER, SecurityConstants.DEFAULT_IMAGE_IMPL);
